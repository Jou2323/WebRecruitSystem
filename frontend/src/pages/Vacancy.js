                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        
                                        {
                                            ...
                                            <td class="text-center"><Link class="btn btn-primary" role="button" style={{marginTop: '12px',marginBottom: '14px',marginLeft: '0px', marginRight: '2px', paddingRight: '10px'}} to={`/ViewVacancy/${vacancy.id}`}>Info</Link></td>
